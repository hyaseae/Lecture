...
auto all_equal(T now, Args... rest)
{
    return ((now == rest) && ...);

    // now == arg1 && now == arg2 && now = arg3 && ...
    // ((now == arg1) == arg2) == arg3 ...
}
...
//    std::cout << "Accumulated floats: " << integer_acc.get_total() << std::endl;
    ...
    /*
        integer_acc이 float에서 값을 제출할 수 없음.   
